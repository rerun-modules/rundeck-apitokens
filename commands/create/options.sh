...
# Created: Wed Dec 23 07:51:03 PST 2015
#
#/ usage: rundeck-apitokens:create  --token-user <>  --url <$RUNDECK_URL> [ --username <$RUNDECK_USER>] [ --password <$RUNDECK_PASSWORD>] [ --apikey <$RUNDECK_APIKEY>] 
