...
# Created: Wed Dec 23 07:32:41 PST 2015
#
#/ usage: rundeck-apitokens:list  --url <$RUNDECK_URL> [ --username <$RUNDECK_USER>] [ --password <$RUNDECK_PASSWORD>] [ --apikey <$RUNDECK_APIKEY>]  --token-user <> 
